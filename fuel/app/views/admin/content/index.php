                            ...
                            <td>
                                <div class="dropdown">
                                    ...
                                    <ul class="dropdown-menu" aria-labelledby="drop1">
                                      <li><a href="/admin/content/view/<?= $model->id ;?>">Просмотреть</a></li>
                                      <li><a href="/admin/content/edit/<?= $model->id ;?>">Редактировать</a></li>
                                      <li><a onclick="confirm('Вы уверены?')" href="/admin/content/delete/<?= $model->id ;?>">Удалить</a></li>
